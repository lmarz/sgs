...
int check_authorization(Request* request) {
    ...
    return strcmp(request->authorization, "admin:admin") == 0 ? 1 : 0;
}
...
int main(int argc, char *argv[]) {
    ...
    while(1) {
        ...
        if(request.authorization == NULL && strcmp(request.query_string, "service=git-receive-pack") == 0) {
